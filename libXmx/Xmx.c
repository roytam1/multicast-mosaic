   ...
   XtCallbackProc ginit_cb)
{
  ...
  XtManageChild (Xmx_w);
  XtAddCallback (Xmx_w, GlxNexposeCallback, redraw_cb, 0);
  XtAddCallback (Xmx_w, GlxNresizeCallback, resize_cb, 0);
  XtAddCallback (Xmx_w, GlxNginitCallback, ginit_cb, 0);
  Xmx_n = 0;
  return Xmx_w;
}
   ...
   XtCallbackProc ginit_cb)
{
  ...
  Xmx_w = XtCreateWidget("drawingvolume", glibWidgetClass, 
		parent, Xmx_wargs, Xmx_n);
  XtManageChild (Xmx_w);
  XtAddCallback (Xmx_w, XglNexposeCallback, redraw_cb, 0);
  XtAddCallback (Xmx_w, XglNresizeCallback, resize_cb, 0);
  XtAddCallback (Xmx_w, XglNgconfigCallback, ginit_cb, 0);
  Xmx_n = 0;
  return Xmx_w;
}
